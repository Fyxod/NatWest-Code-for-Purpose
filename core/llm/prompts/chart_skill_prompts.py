...
def chart_plan_prompt(
    ...
    system_prompt = (
        ...
        "- scatter3d: relationship among three numeric variables (x, y, z)\n"
        "- bubble: x/y relationship with bubble size as third metric\n"
        "- radar: multi-metric category comparison\n"
        "- composed: mixed multi-series visuals\n\n"
        "- heatmap: matrix-style intensity across categories/series\n"
        "- treemap: hierarchical part-to-whole using one value metric\n\n"
        "Rules:\n"
